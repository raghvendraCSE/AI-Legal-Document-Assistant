...
GREETINGS = {"hi", "hello", "hlo", "hey", "hii", "thanks", "thank you", "ok", "okay"}
...
if uploaded_file is not None:
    ...
    # Limit text size to prevent memory crash (raised from 5000)
    text = text[:50000]
    ...
    # -----------------------------
    # Create vector database (only once per uploaded file)
    # -----------------------------
